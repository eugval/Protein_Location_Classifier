...
from errorAnalysisAPI import make_characterisation_histograms , plot_roc_curves, plot_confusion_matrix
...
print("precision macro :{} std: {}".format(cv_rec_macro,cv_std_rec_macro))
...
make_characterisation_histograms(x_test_dicts,"hydrophobicity_global",y_pred,y_test, "hydrophobicity")
make_characterisation_histograms(x_test_dicts,"isoelectric_point_global",y_pred,y_test, "isoelectric point")

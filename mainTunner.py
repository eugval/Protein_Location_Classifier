...
#feat_params = tune_features(x_raw_train, x_raw_test, y_train, y_test)
...
gb_test_score, _, _ = GBCV(models_folder,data_folder,save_suffix,extension)

print("GBCV finished")
print(gb_test_score)

sv_test_score, _, _ = SVMCV(models_folder,data_folder,save_suffix,extension)

print("SVMCV finished")
print(sv_test_score)

rf_test_score,_,_ =RFCV(models_folder,data_folder,save_suffix,extension)

print("Random forest finished")
print(rf_test_score)

lr_test_score, _,_ = LRCV(models_folder,data_folder,save_suffix,extension)
